// Desktop icon glyphs reused by the mobile components — same SVGs the desktop
// designer renders, inlined here where the desktop keeps them inside JSX
// (GraphicEditorBar duplicate/delete, the size-popover +/- steppers). Icons
// that exist as standalone assets are used directly from /public/icons; the
// editor-bar B/I/U/align and the help-menu mail/phone icons are imported from
// their desktop components.

type IconProps = { className?: string }

// GraphicEditorBar's Duplicate glyph (16x16).
...
// GraphicEditorBar's Delete (trash) glyph (24x24).
...
// The size-popover quantity steppers' minus/plus glyphs (20x20) — also the
// zoom control's +/-.

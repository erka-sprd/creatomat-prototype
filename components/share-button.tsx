        ...
        <>
            <div className="group/tooltip relative flex">
                <button
                    ...
                    // Its own pill (no longer half of a button group). The frame
                    // drops away while the canvas marks the plain state — see
                    // the wrapper in designer.tsx.
                    className="flex cursor-pointer items-center justify-center rounded-full border border-neutral-200 bg-[#F4F4F4] px-3.5 py-3 text-neutral-700 outline-none transition-colors hover:bg-white hover:text-black in-data-[canvas-actions-plain]:border-transparent in-data-[canvas-actions-plain]:bg-transparent"
                >
                    <svg viewBox="0 0 24 24" fill="currentColor" className="size-[20px]" aria-hidden>
